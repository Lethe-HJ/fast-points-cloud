...
// 环境光 #494949
const ambient = new THREE.AmbientLight(0x494949);
scene.add(ambient);
...
const mesh1 = new THREE.Mesh(boxGeometry, phongMaterial);
...
const mesh2 = new THREE.Mesh(boxGeometry, lambertMaterial);
